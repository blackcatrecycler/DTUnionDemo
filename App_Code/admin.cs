...
namespace God_admin
{
    public class admin
    {
        //static string str = @"Data Source=(localdb)\v11.0; Initial Catalog=dtunion; User ID=sa;Password=sa";
        static string str = @"Data Source=(localdb)\v11.0; Initial Catalog=dtunion; integrated security = True;";
